...
public class KnightMovePattern : IMovePattern
{
    ...
    public IEnumerable<IEnumerable<Move>> Patterns =>
        ...
        {
            // 1
            new() { Move.Up, Move.DiagonalUpLeft },
            // 2
            new() { Move.Up, Move.DiagonalUpRight },
            // 3
            new() { Move.Right, Move.DiagonalUpRight },
            // 4
            new() { Move.Right, Move.DiagonalDownRight },
            // 5
            new() { Move.Down, Move.DiagonalDownRight },
            // 6
            new() { Move.Down, Move.DiagonalDownLeft },
            // 7
            new() { Move.Left, Move.DiagonalDownLeft },
            // 8
            new() { Move.Left, Move.DiagonalUpLeft },
        };
}
